...
<GenericSection id="home-section">
    ...
    <p>A Computation Science master student with a background in physics and astronomy. Loves a challenge and has an interest in a wide range of fields, ranging from game development to finance, and from physics to web development. </p>
